...
docs/recipe.js: recipe.ts
	tsc --lib dom,es2016 --noImplicitReturns --strictNullChecks --noUnusedLocals --noUnusedParameters --noImplicitThis --noImplicitAny --noFallthroughCasesInSwitch --newLine LF --outfile "$@" "$<"
